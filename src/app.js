 ...
 * Connect to MongoDB.
 */
mongoose.connect(process.env.MONGODB_URI || process.env.MONGOLAB_URI || process.env.MONGOLAB_ONYX_URI);
...
app.use(session({
  ...
  store: new MongoStore({
    url: process.env.MONGODB_URI || process.env.MONGOLAB_URI || process.env.MONGOLAB_ONYX_URI,
    autoReconnect: true
  })
}));
...
app.get('/api/trello', trelloController.get);
